# Adapted from https://github.com/datameet/india-election-data/tree/master/constituencies
...
def run(filename):
    ...
    out_csv = open("../../srcdata/delimitation/andhra-bifurcation-2014.csv", "w")
    out = csv.writer(out_csv, lineterminator='\n')
...
if __name__ == '__main__':
    run('../../srcdata/delimitation/andhra-bifurcation-2014.txt')
