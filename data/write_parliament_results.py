...
def main():
    ...
    with open("../srcdata/parliament_elections_data.csv", "r") as incoming_results_csv:
        incoming_results = list(csv.reader(incoming_results_csv))
    incoming_results_csv.close()

    with open("parliament.csv", "r") as parliament_csv:
    ...
    with open("parliament_results.csv", "w") as outgoing_results_csv:
